...
public class CurrentRatingsModel(
    ...
    OlderBaseRatingsModel(schoolService, schoolOverviewDetailsService, trustService, dataSourceService, otherServicesLinkBuilder, schoolNavMenu, ofstedService, powerBiLinkBuilderService)
{
