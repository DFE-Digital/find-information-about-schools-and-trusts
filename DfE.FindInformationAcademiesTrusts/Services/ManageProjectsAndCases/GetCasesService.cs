...
public class GetCasesService(ICasesClient caseAggregationServiceClient) : IGetCasesService
{
    public async Task<IPaginatedList<UserCaseInfo>> GetCasesAsync(GetCasesParameters parameters)
    {
        ...
        return new PaginatedList<UserCaseInfo>(cases.CaseInfos, cases.TotalRecordCount, parameters.Page,
            parameters.RecordCount);
    }
}
