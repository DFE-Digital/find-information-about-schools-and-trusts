    ...
    public class ReportCardsServiceTests
    {
        ...
        public ReportCardsServiceTests()
        {
            ...
            _mockReportCardsRepository.GetReportCardAsync(Urn)
                .Returns((new EstablishmentReportCard(new DateOnly(2025, 01, 20), "https://ofsted.gov.uk/1", "Good", "Good", "Excellent", "Good", "Good", "Outstanding", null, "Met"), 
                    new EstablishmentReportCard(new DateOnly(2023, 09, 18), "https://ofsted.gov.uk/2", "Good", "Good", "Excellent", "Good", "Good", "Outstanding", null, "Not Met")));

            _mockCacheService.GetOrAddAsync(Arg.Any<string>(), Arg.Any<Func<Task<(EstablishmentReportCard? LatestReportCard, EstablishmentReportCard? PreviousReportCard)>>>(), Arg.Any<string>())
                .Returns(callInfo =>
                {
                    var callback = callInfo.ArgAt<Func<Task<(EstablishmentReportCard? LatestReportCard, EstablishmentReportCard? PreviousReportCard)>>>(1);
                    return callback();
                });
        }
        ...
        {
            _mockReportCardsRepository.GetReportCardAsync(Urn).Returns((null, new EstablishmentReportCard(new DateOnly(2025, 01, 20), "https://ofsted.gov.uk/1", "Good", "Good", "Excellent", "Good", "Good", "Outstanding", null, "Met")));
        ...
        {
            _mockReportCardsRepository.GetReportCardAsync(Urn).Returns((new EstablishmentReportCard(new DateOnly(2025, 01, 20), "https://ofsted.gov.uk/1", "Good", "Good", "Excellent", "Good", "Good", "Outstanding", null, "Met"), null));
