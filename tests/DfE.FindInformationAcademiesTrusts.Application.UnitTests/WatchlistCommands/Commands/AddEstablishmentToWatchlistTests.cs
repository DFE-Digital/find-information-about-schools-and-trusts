...
public class AddEstablishmentToWatchlistTests
{
    private readonly Mock<IWatchlistRepository> _mockWatchlistRepository;
    private readonly CancellationToken _cancellationToken;

    public AddEstablishmentToWatchlistTests()
    {
    ...
    public async Task Handle_ValidCommand_AddsWatchlistRecordAndReturnsTrue()
    {
        ...
        var command = new AddEstablishmentToWatchlistCommand(establishmentId, user);
        ...
        var handler = new AddEstablishmentToWatchlist.AddEstablishmentToWatchlistCommandHandler(_mockWatchlistRepository.Object);
    ...
    public async Task Handle_CalledTwice_CreatesRecordsWithDifferentIds()
    {
        ...
        var handler = new AddEstablishmentToWatchlist.AddEstablishmentToWatchlistCommandHandler(_mockWatchlistRepository.Object);
        var command = new AddEstablishmentToWatchlistCommand("100001", "user");
