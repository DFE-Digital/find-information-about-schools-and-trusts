...
public class PreviousRatingsModelTests : BaseOfstedAreaModelTests<PreviousRatingsModel>
{
    ...
    [Fact]
    public async Task OnGetAsync_should_set_InspectionBeforeJoiningTrust_to_null_when_school_is_la()
    {
        var expectedRating = new OfstedRating(
            OfstedRatingScore.Good,
            OfstedRatingScore.Good,
        ...
        Sut.InspectionBeforeJoiningTrust.Should().BeNull();
    }
    
    [Fact]
    public async Task OnGetAsync_should_set_InspectionBeforeJoiningTrust_to_false_when_school_is_academy_and_previous_inspection_date_is_after_date_joined_trust()
    {
        Sut.Urn = AcademyUrn;
        ...
        Sut.InspectionBeforeJoiningTrust.Should().BeFalse();
    }
    
    [Fact]
    public async Task OnGetAsync_should_set_InspectionBeforeJoiningTrust_to_true_when_school_is_academy_and_previous_inspection_date_is_before_date_joined_trust()
    {
        Sut.Urn = AcademyUrn;
        ...
        Sut.InspectionBeforeJoiningTrust.Should().BeTrue();
    }
}
