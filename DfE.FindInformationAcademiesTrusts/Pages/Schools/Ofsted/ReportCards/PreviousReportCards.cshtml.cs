...
namespace DfE.FindInformationAcademiesTrusts.Pages.Schools.Ofsted.ReportCards
{
    public class PreviousReportCardsModel(
        ...
        IPowerBiLinkBuilderService powerBiLinkBuilderService) : BaseReportCardsRatingsModel(schoolService, schoolOverviewDetailsService, trustService,
        dataSourceService, otherServicesLinkBuilder, schoolNavMenu, reportCardsService, powerBiLinkBuilderService)
    {
